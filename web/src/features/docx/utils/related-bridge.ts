...
/** Clona el nodo relacionado a HTML estático para la tarjeta colapsada. */
function cloneRelatedNodeHtml(relatedElement: HTMLElement): string {
	const clone = relatedElement.cloneNode(true) as HTMLElement;
...
export function computeRelatedBridge({
	...
	for (const item of related) {
		...
		anchors.push({
			...
			html: cloneRelatedNodeHtml(relatedElement),
		});
	}
